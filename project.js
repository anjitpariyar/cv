...
window.addEventListener('scroll',function(){
	...
	contact.style.transform='translate3d(0, '+scrolled*0.2+'px, 0)';
    
	phone.style.transform='translate3d('+scrolled*0.4+'px,0, 0)';
	addtop.style.transform='translate3d('+scrolled*(-0.1)+'px,0, 0)';
